...
* Backend: Managed via server-side ModuleScripts to prevent exploit bomboclad
...
* payment%: 40% upfront (if group fund idk bout tax), 60% upon completing.
* req: Add me to a group on day1 so no late paying (if without tax meaning got time).
